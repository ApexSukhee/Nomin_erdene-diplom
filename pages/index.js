    ...
    <>
      ...
      <div className="w-full">
        <Head>
          ...
          <meta
            name="description"
            content="Онлайн дэлгүүр Next provides a way to quickly get up and running with a fully configurable ECommerce site using Next.js."
          />
          <meta property="og:title" content="Онлайн дэлгүүр" key="title" />
        </Head>
        <div
